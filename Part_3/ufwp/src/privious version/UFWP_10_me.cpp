...
{
this->sct=1;
string p=to_string(getInt("physics"));
string c=to_string(getInt("chemistry"));
string m=to_string(getInt("maths"));
string h=to_string(getInt("hindi"));
string e=to_string(getInt("english"));
string s1="${physics}";
string s2="${chemistry}";
string s3="${maths}";
string s4="${hindi}";
