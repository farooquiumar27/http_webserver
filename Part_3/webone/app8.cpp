...
request.forward_tech2("/functionFour");
}
...
void _for(Request &request,Response &response)
{
//request.forward("/forOne");
request.forward_tech2("/forOne");
}
void forOne(Request &request,Response &response)
{
cout<<"##############Forwarded first time##############"<<endl;
response.write("<! DOCTYPE HTML>");
response.write("<html lang='en'>");
response.write("<meta charset='utf-8'>");
response.write("<head>");
...
response.write("<body>");
response.write("ABCL is a shining star");
//request.forward("/forTwo");
request.forward_tech2("/forTwo");
}
void forTwo(Request &request,Response &response)
{
cout<<"##############Forwarded second time##############"<<endl;
int num1,num2,num3;
num1=request.getInt("abcd");
num2=request.getInt("pqr");
num3=request.getInt("lmn");
...
if(cityCode==1)request.forward_tech2("/Ujjain.html");
else if(cityCode==2)request.forward_tech2("/Indore.html");
else if(cityCode==3)request.forward_tech2("/Dewas.html");
else request.forward_tech2("/index.html");
}
int main( )
{
...
server.onRequest("/functionFour",functionFour);
server.onRequest("/functionFour",functionFour);
server.onRequest("/for",_for);
server.onRequest("/forOne",forOne);
server.onRequest("/forTwo",forTwo);
